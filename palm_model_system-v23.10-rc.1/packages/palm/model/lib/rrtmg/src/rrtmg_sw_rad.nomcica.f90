...
!------------------------------------------------------------------
      ...
      subroutine rrtmg_sw &
            (ncol    ,nlay    ,icld    ,iaer    , &
             ...
             ch4vmr  ,n2ovmr  ,o2vmr   ,asdir   , &
             asdif   ,aldir   ,aldif   ,coszen  , &
             adjes   ,dyofyr  ,scon    ,inflgsw , &
             iceflgsw,liqflgsw,cldfr   ,taucld  , &
             ssacld  ,asmcld  ,fsfcld  ,cicewp  , &
             cliqwp  ,reice   ,reliq   ,tauaer  , &
             ssaaer  ,asmaer  ,ecaer   ,swuflx  , &
             swdflx  ,swhr    ,swuflxc ,swdflxc , &
             swhrc   ,dirdflux,difdflux)
...
!-- Added the output direct and diffuse fluxes to the argument of rrtmg_sw
!     Aug 2018: M. Salim, Humboldt Uni, Berlin, Germany
...
! Optional output fields 
      ...
      real(kind=rb), intent(out) :: dirdflux(nlay+2)       ! Direct downward shortwave surface flux
