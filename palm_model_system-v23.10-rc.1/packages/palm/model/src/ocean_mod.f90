...
!-- Check for invalid combinations
    ...
    IF ( particle_coupling  .AND.  particle_advection )  THEN
       message_string = 'ocean mode does not allow particle_coupling = .T.'
       CALL message( 'ocean_check_parameters', 'OMC0013', 3, 2, 0, 6, 0 )
    ENDIF
