...
!   VAR(ind_spc) = C(ind_spc)
  ...
  INTEGER, PARAMETER, PUBLIC :: ind_o3 = 7 
  INTEGER, PARAMETER, PUBLIC :: ind_no = 8 
...
! X - Vector for variables
  ...
  x(7) = x(7) - jvs(9) * x(6)
  x(8) = x(8) - jvs(12) * x(6) - jvs(13) * x(7)
  x(8) = x(8) / jvs(14)
  x(7) = (x(7) - jvs(11) * x(8)) /(jvs(10))
  x(6) = (x(6) - jvs(7) * x(7) - jvs(8) * x(8)) /(jvs(6))
  x(5) = x(5) / jvs(5)
  x(4) = x(4) / jvs(4)
  x(3) = x(3) / jvs(3)
  x(2) = x(2) / jvs(2)
...
!   i = 7
    jvs(9) = (jvs(9)) / jvs(6) 
    jvs(10) = jvs(10) - jvs(7) * jvs(9)
    jvs(11) = jvs(11) - jvs(8) * jvs(9)
!   i = 8
    jvs(12) = (jvs(12)) / jvs(6) 
    a = 0.0; a = a  - jvs(7) * jvs(12)
    jvs(13) = (jvs(13) + a) / jvs(10) 
    jvs(14) = jvs(14) - jvs(8) * jvs(12) - jvs(11) * jvs(13)
    RETURN                                                            
