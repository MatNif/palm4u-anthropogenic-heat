...
! NONZERO - Number of nonzero entries in Jacobian
  INTEGER, PARAMETER :: nonzero = 4 
! LU_NONZERO - Number of nonzero entries in LU factoriz. of Jacobian
  INTEGER, PARAMETER :: lu_nonzero = 4 
...
!   VAR(ind_spc) = C(ind_spc)
  ...
  INTEGER, PARAMETER, PUBLIC :: ind_pol_betu = 1 
  INTEGER, PARAMETER, PUBLIC :: ind_pol_ambr = 2 
  INTEGER, PARAMETER, PUBLIC :: ind_pol_poac = 3 
  INTEGER, PARAMETER, PUBLIC :: ind_pol_alnu = 4 
