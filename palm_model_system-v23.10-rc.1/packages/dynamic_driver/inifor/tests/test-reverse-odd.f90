...
!------------------------------------------------------------------------------!
 PROGRAM test_reverse_odd
    ...
    CHARACTER(LEN=*), PARAMETER ::  title = "array reversion odd no of elements"
    LOGICAL                     ::  res

    REAL(wp), DIMENSION(1,1,5) :: array, reversed_array

    CALL begin_test(title, res)

    ! Arange
    array(1,1,:) = (/1.0_wp, 2.0_wp, 3.0_wp, 4.0_wp, 5.0_wp/)
    reversed_array(1,1,:) = (/5.0_wp, 4.0_wp, 3.0_wp, 2.0_wp, 1.0_wp/)
